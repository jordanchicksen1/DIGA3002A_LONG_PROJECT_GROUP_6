...
public class lastBoss : MonoBehaviour
{
    ...
    public lastBossHealth lastBossHealth;
    ...
    public void Update()
    {
        ...
        if (lastBossPosture.isStaggered == false)
        {
    ...
    public IEnumerator SpreadshotPhase2()
    {
        yield return new WaitForSeconds(0f);
        moveSpeed = 0f;
        var projectile = Instantiate(bigProjectiles, shootPoint1.position, shootPoint1.rotation);
        var rb = projectile.GetComponent<Rigidbody>();
        rb.velocity = shootPoint1.forward * bigProjectileSpeed;
        Destroy(projectile, 1.5f);
        var projectile2 = Instantiate(mediumProjectiles, shootPoint2.position, shootPoint2.rotation);
        var rb2 = projectile2.GetComponent<Rigidbody>();
        rb2.velocity = shootPoint2.forward * mediumProjectileSpeed;
    ...
    public IEnumerator SpreadshotPhase3()
    {
        ...
        var projectile4 = Instantiate(bigProjectiles, shootPoint1.position, shootPoint1.rotation);
    ...
    public IEnumerator ConsecutiveShotPhase1()
    {
        ...
        Destroy(projectile, 1.5f);
        yield return new WaitForSeconds(0.5f);
        var projectile2 = Instantiate(mediumProjectiles, shootPoint1.position, shootPoint1.rotation);
        var rb2 = projectile2.GetComponent<Rigidbody>();
    ...
    public IEnumerator ConsecutiveShotPhase3()
    {
        ...
        Destroy(projectile, 1.5f);
        yield return new WaitForSeconds(0.5f);
        var projectile2 = Instantiate(bigProjectiles, shootPoint1.position, shootPoint1.rotation);
        var rb2 = projectile2.GetComponent<Rigidbody>();
        rb2.velocity = shootPoint1.forward * bigProjectileSpeed;
        Destroy(projectile2, 1.5f);
        yield return new WaitForSeconds(0.5f);
        var projectile3 = Instantiate(mediumProjectiles, shootPoint1.position, shootPoint1.rotation);
        var rb3 = projectile3.GetComponent<Rigidbody>();
